...
-- modules, types and known values are magenta
...
set_hl('Number',                 { fg = hl.magenta })
set_hl('@number',                { fg = hl.magenta })
set_hl('@number.float',          { fg = hl.magenta })
set_hl('Boolean',                { fg = hl.magenta })
set_hl('@boolean',               { fg = hl.magenta })
set_hl('Constant',               { fg = hl.magenta })
set_hl('@constant',              { fg = hl.magenta })
set_hl('@constant.macro',        { fg = hl.magenta })
set_hl('@constant.builtin',      { fg = hl.magenta })
